...
public interface AppConstants {
    ...
    String PARSE_APP_ID = "vdk2dWeLN97aSQjScQ1G52PbqRGckyiMBTVuWUzB";

    String PARSE_CLIENT_ID = "IyrbQV9SmykHbUkkt4eZBooJv4L8T7cV4lqC0HTN";
    ...
    public static interface PARAMS {
        ...
        String CHALLENGES_SENT = "challengesSent";
        String SEATS = "Seats";
